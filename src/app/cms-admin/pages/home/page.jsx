      ...
      if (res.ok) {
        ...
        const defaultSections = {
          ...
          services: {
            ...
            subtitle: 'From device repairs to web solutions, we provide comprehensive tech services.',
            items: [
              { id: 'computer-repair', title: 'Computer Repair', shortDesc: 'Expert diagnostics & repair', description: 'Professional computer repair for all brands.', features: ['Hardware Repair', 'Virus Removal', 'Data Recovery', 'Upgrades'] },
              { id: 'cell-phone-repair', title: 'Cell Phone Repair & Unlocking', shortDesc: 'Screen repair & carrier unlock', description: 'Fast and reliable cell phone repair.', features: ['Screen Repair', 'Battery Replacement', 'Unlocking', 'Water Damage'] },
              { id: 'device-sales', title: 'Mobile & Computer Sales', shortDesc: 'Quality devices & accessories', description: 'Wide selection of new and refurbished devices.', features: ['New Devices', 'Refurbished', 'Accessories', 'Best Prices'] },
              { id: 'web-development', title: 'Web Development', shortDesc: 'Custom websites & apps', description: 'Professional web development services.', features: ['Custom Websites', 'E-Commerce', 'SEO Optimized', 'Responsive'] },
            ],
          },
          about: {
