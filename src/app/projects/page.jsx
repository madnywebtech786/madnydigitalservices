        ...
        <Container className="relative z-10 py-24">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold text-gradient">Portfolio Showcase</span>
            ...
            >
              Discover cutting-edge digital solutions that transform businesses and delight users
            </motion.p>
            ...
            >
              {[
                { icon: TrendingUp, label: 'Projects', value: '50+', color: 'from-blue-500 to-cyan-500' },
                { icon: Users, label: 'Clients', value: '200+', color: 'from-purple-500 to-pink-500' },
                { icon: Star, label: 'Rating', value: '4.8', color: 'from-orange-500 to-yellow-500' },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
                ...
                >
                  ...
                  <div className="relative p-6 rounded-2xl bg-white/50 backdrop-blur-xl border border-white/50 hover:border-primary/20 shadow-lg group-hover:shadow-2xl transition-all duration-300">
                    <div className={`w-12 h-12 rounded-xl bg-linear-to-br ${stat.color} flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300`}>
                ...
                {projectCategories.map((category, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`relative px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 ${
                        isActive
                          ? 'text-white'
                        ...
                        {isActive && (
                          <motion.span
                            initial={{ opacity: 0, scale: 0 }}
                            animate={{ opacity: 1, scale: 1 }}
                            className="ml-2 inline-flex items-center justify-center w-6 h-6 rounded-full bg-white/20 text-xs"
                          >
              ...
              >
                ...
                {(selectedCategory !== 'all' || searchQuery) && (
                  <button
                    ...
                    className="text-primary hover:text-primary-dark font-semibold flex items-center gap-1 hover:gap-2 transition-all"
                  >
                    <X className="w-4 h-4" />
                    Clear Filters
                  </button>
...
function ProjectCard({ project, index, isHovered, onHover, onLeave }) {
  ...
  const categoryColor = projectCategories.find(c => c.id === project.category)?.color || 'from-gray-500 to-gray-600';
  ...
  return (
    <Link href={`/projects/${project.id}`}>
      ...
      {/* Glow Effect */}
      <motion.div
        className={`absolute -inset-4 bg-gradient-to-r ${categoryColor} rounded-3xl opacity-0 group-hover:opacity-20 blur-2xl transition-all duration-500`}
      ...
      <div className="relative h-full rounded-2xl bg-white border-2 border-gray-100 hover:border-transparent overflow-hidden transition-all duration-500 flex flex-col shadow-lg hover:shadow-2xl">
        ...
        <div className="relative h-72 overflow-hidden">
          ...
          {project.featured && (
            <motion.div
              ...
              className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs font-black flex items-center gap-1.5 shadow-lg"
            >
          ...
          >
            <button
              ...
              className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-xl border border-white/30 flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all duration-300 group/btn"
            >
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {project.tags.slice(0, 3).map((tag, i) => (
              <motion.span
                ...
                className="px-3 py-1 text-xs font-semibold rounded-lg bg-gray-100 text-gray-700"
              >
                {tag}
              </motion.span>
            ))}
          ...
          <motion.div
            whileHover={{ x: 5 }}
            className="flex items-center gap-2 text-primary font-bold text-sm group/btn self-start"
          >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-32 h-32 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 mx-auto mb-6 flex items-center justify-center"
      >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onReset}
        className="px-8 py-4 rounded-xl bg-gradient-to-r from-primary to-primary-dark text-white font-bold shadow-lg hover:shadow-xl transition-all"
      >
        Reset All Filters
      </motion.button>
    </motion.div>
