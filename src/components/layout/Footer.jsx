            ...
            <div className="flex gap-3 mt-6">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center hover:bg-gradient-to-br hover:from-primary hover:to-secondary transition-all duration-300"
            ...
            <ul className="space-y-3">
              {footerLinks.services.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-white/70 text-sm hover:text-primary transition-colors duration-300 flex items-center gap-1 group"
                  >
                    {link.name}
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-2">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 rounded-xl bg-gradient-to-r from-primary to-secondary text-sm font-medium"
                >
                  Join
                </motion.button>
              </div>
