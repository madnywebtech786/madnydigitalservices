  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden bg-gradient-to-b from-white via-gray-50/50 to-white">
      ...
      <Container className="relative z-10">
        ...
        >
          <SectionHeader
            subtitle={d.badge || 'Testimonials'}
            title={d.title || 'What Our Clients Say'}
            description={d.description || "Don't just take our word for it. Here's what Calgary businesses and individuals have to say about our services."}
          />
        </motion.div>
      </Container>
      ...
      <Container>
        ...
        >
          <p className="text-gray-500 text-sm">
            Trusted by <span className="text-primary font-semibold">{d.bottomCount || '500+'}</span>{' '}
            {d.bottomText || 'satisfied customers in Calgary'}
          </p>
        </motion.div>
      </Container>
    </section>
