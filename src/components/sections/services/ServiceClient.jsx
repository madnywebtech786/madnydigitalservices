...
const getIconForService = (id) => {
  switch (id) {
    ...
    case 'software-development': return Terminal;
        ...
        <Container>
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-7 relative">
              ...
              {/* Rating badge — static, brand-colored */}
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-xl z-20">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary to-secondary flex items-center justify-center shrink-0 shadow-md">
